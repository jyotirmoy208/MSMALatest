...
class MSMA:
    ...
    def get_selective_mutation(self,childDict):
        ...
        for key in childDict:
            ...
            generator_range = len(singlechild) / 6
            mutantThreshold = math.floor(len(singlechild) * .1)
            #mutantList = []
            ...
            for itr in range(100):
                ...
                for key1 in range(len(singlechild)):
                    ...
                    check_mutant=randomnumber%2
                    if count < mutantThreshold and check_mutant==0:
    ...
    def get_selective_mutation_dunn(self,childDict):
        ...
        for key in childDict:
            ...
            singlechild = childDict[key]
            generator_range = len(singlechild)/6
            mutantThreshold = math.floor(len(singlechild) * .05)
            #mutantList = []
    ...
    def start_clustering(self):
        ...
        for outerstage in range(40):
         counter = 0
         parent_dict = {}
         survivor_dict = {}
         print('outerstage',outerstage)
...
if __name__ == '__main__':
    ...
    print('jacard', jacardkmean1)
    kmeanssilhot = obj.calculate_silhoutte("", kmeans1.labels_)
    print('kmeanssilhotte',kmeanssilhot)
    ...
    kmdiodilhot = obj.calculate_silhoutte("", kmediodlabels1)
    print('kmdiodilhot', kmeanssilhot)
