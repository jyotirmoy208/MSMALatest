...
if __name__ == '__main__':
    test_labels = np.zeros(178, int)
    test_labels[0:58] = np.int(1)
    test_labels[59:130] = np.int(2)
    ...
    #result1=np.loadtxt(open("C:\personal\PhD\Dataset\Anomaly\Wine\\real_6.csv", "r"),
     #                    delimiter=",")
   ...
   # print("kmeans without meme", confusion_matrix(test_labels, kmeans1.labels_))
    ...
    M1, C1 = kMedoids(D1, 3)
    kmediodlabels1 = convertLabelsToList(M1, C1, 178)
